...
//
//
#ifndef STORKNeutronHPEnAngCorrelation_h
#define STORKNeutronHPEnAngCorrelation_h 1
...
#include <fstream>
#include "globals.hh"
#include "STORKNeutronHPProduct.hh"
#include "G4ReactionProduct.hh"

class STORKNeutronHPEnAngCorrelation
{
  public:
  ...
  inline void Init(std::istream & aDataFile)
  {
    ...
    theProducts = new STORKNeutronHPProduct[nProducts];
  ...
  G4int nProducts;
  STORKNeutronHPProduct * theProducts;
  G4bool inCharge;
