...
//
//
#ifndef STORKNeutronHPEnergyDistribution_h
#define STORKNeutronHPEnergyDistribution_h 1
...
#include "G4NeutronHPLevScatt.hh"
#include "G4NeutronHPEvapSpectrum.hh"
#include "G4NeutronHPSimpleEvapSpectrum.hh"
#include "G4NeutronHPRestrictedSimpleEvapSpectrum.hh"
#include "G4NeutronHPFissionSpectrum.hh"
#include "G4NeutronHPRestrictedFissionSpectrum.hh"
#include "G4NeutronHPWattSpectrum.hh"
#include "G4NeutronHPRestrictedWattSpectrum.hh"
#include "G4NeutronHPMadlandNixSpectrum.hh"
#include "G4VNeutronHPEDis.hh"

// we will need a List of these .... one per term.

class STORKNeutronHPEnergyDistribution
{
  public:
  STORKNeutronHPEnergyDistribution()
  {
  ...
  inline void Init(std::istream & theData)
  {
	...
	case 1:
          ...
          break;
    case 3:
          theEnergyDistribution[i] = new G4NeutronHPLevScatt;
          break;
	case 5:
	...
	case 7:
          ...
          break;
    case 8:
          theEnergyDistribution[i] = new G4NeutronHPRestrictedFissionSpectrum;
          break;
	case 9:
          theEnergyDistribution[i] = new G4NeutronHPSimpleEvapSpectrum;
          break;
    case 10:
          theEnergyDistribution[i] = new G4NeutronHPRestrictedSimpleEvapSpectrum;
          break;
	case 11:
          theEnergyDistribution[i] = new G4NeutronHPWattSpectrum;
          break;
    case 13:
          theEnergyDistribution[i] = new G4NeutronHPRestrictedWattSpectrum;
          break;
	case 12:
